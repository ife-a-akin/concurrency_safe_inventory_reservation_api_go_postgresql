...
- Products must be created before orders can be placed.<br>
...
- Add timestamp to orders for better logginh<br>
- Add additional endpoints for listing products and orders.<br>
